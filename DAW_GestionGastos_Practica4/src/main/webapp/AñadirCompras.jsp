...
<body>
    ...
    <div class="container mt-3 mx-auto text-center">
        <h1 class=" mx-auto text-center mt-5">Añadir Compra</h1>
        
       

        <form action="ServletCompras" method="post">
            <div class="mb-3">
                <label for="importeCompra" class="form-label">Importe de la Compra:</label> 
                    <input type="text"  id="importeCompra"
                    name="importeCompra" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="idUsuarioFK" class="form-label">ID de Usuario:</label>
              
                
	<input type="text" id="idUsuarioFK" name="idUsuarioFK" value="<%= (session != null) ? session.getAttribute("idUsuarioFK") : "" %>" required readonly>
            </div>

            <div class="mb-3">
                <label for="idTiendaFK" class="form-label">Nombre de la Tienda:</label>
                <select  id="idTiendaFK" name="idTiendaFK" required>
                    <%
            ...
            <input type="hidden" name="operacion" value="anadirCompra">

            <button type="submit" class="btn btn-warning">Agregar Compra</button>
        </form>
    </div>
